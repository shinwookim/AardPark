...
@router.post("/booking/")
def new_booking(
    purchaser: Annotated[str, Query(description="The user who is purchasing the spot")],
    seller: Annotated[str, Query(description="The user who is purchasing the spot")],
    parking_spot: Annotated[
        str, Query(description="The user who is purchasing the spot")
    ],
...
def get_individual_booking(
    user_id: Annotated[
        str, Path(description="The user id to see purchases and sellers.")
    ]
):
